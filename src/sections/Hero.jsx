...
flex-col  justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        text-8xl max-sm:text-[72px]  font-bold">
          <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-10"> The New Arrival</span>
          <br />
          <span className="text-coral-red inline-block mt-3">Nike</span>  Shoes
        </h1>
        <p className=" font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14
         sm:max-w-sm">Discover stylish
          Nike arrivaks, quality comfort,
          and innovation for your active
          life.</p>
            ...
            (stat, index) => {
              return (
                <div key={stat.label}>
                  ...
                  <p leading-7 font-montserrat text-slate-gray>{stat.label}</p>
                </div>
              )
            })
          }
